...
public class MyOnlineOrderAdapter extends BaseAdapter {

    Context context;
    ArrayList<OnlineOrderModel> arraylistorder;
    OnlineOrderModel modelOrder;


    public MyOnlineOrderAdapter(Context context, ArrayList<OnlineOrderModel> arraylistorder) {
