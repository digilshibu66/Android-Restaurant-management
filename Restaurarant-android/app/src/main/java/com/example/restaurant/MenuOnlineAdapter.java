...
public class MenuOnlineAdapter extends RecyclerView.Adapter<menuOnlineHolder> {
    ...
    public MenuOnlineAdapter(Context context, List<Model_Menu> arraylistmenu) {
    ...
    @NonNull
    @Override
    public menuOnlineHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.my_custom_menulist,parent,false);

        return new menuOnlineHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull menuOnlineHolder holder, int position) {
...
class menuOnlineHolder extends RecyclerView.ViewHolder
{
    ...
    public menuOnlineHolder(@NonNull View itemView) {
        super(itemView);
        ...
        order.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    String ADD_ORDER=BASEURL+"addonlineorder.php";
                    ...
                    StringRequest request=new StringRequest(Request.Method.POST, ADD_ORDER, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            Intent intent=new Intent(itemView.getContext(),OnlineOrderPay.class);
