...
if(isset($_POST['sub']))
{
    ...
    mysqli_query($conn,"INSERT INTO login_tb(username,password,type) VALUES ('$uname','$pss','2')");
    $id=mysqli_insert_id($conn);
    mysqli_query($conn,"INSERT INTO employee_tb(login_id,name,phone,email,address)VALUES ('$id','$nm','$ph','$eml','$add')");
    echo "<script>alert('New Chef Added')</script>";
                                            ...
                                            <div class="col-lg-8 ml-5">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>Chef </strong> Resgistration
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="email"   class="form-control" name="email" id="email_id" onkeyup="clearmsg('spemail')"></div><span id="spemail" style="color: #F00"></span>
                                                            </div>
                                                           
                                                            
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Address</label></div>
                                                                <div class="col-12 col-md-9"><textarea  rows="9"  class="form-control"  name="address" id="address_id" onkeyup="clearmsg('spaddress')"></textarea><span id="spaddress" style="color: #F00"></span></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                ...
                                                                <span id="spuser" style="color: #F00"></span>
                                                            </div>
                                                            <div class="row form-group">
...
function validate()
{
    ...
    if(name=="")
    {
        ...
        document.getElementById("spname").innerHTML="* Please  name";
    ...
    if(mobile=="")
    {
        ...
        document.getElementById("spphone").innerHTML="* Please  mobile";
