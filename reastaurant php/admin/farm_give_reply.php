...
if(isset($_POST['sub']))
{
    ...
    $query=mysqli_query($conn,"UPDATE farm_request_tb SET reply='$desc' WHERE farm_request_id='$farm_id'");
     
     if($query)
     {
            echo "<script>alert('Reply Added')</script>";
             header("location:farm_request.php");
            ...
            <div class="animated fadeIn">
                <div class="row">                  
                                ...
                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="col-12 col-md-9"><input  type="text"  class="form-control"  name="desc" id="address_id" onkeyup="clearmsg('spaddress')"><span id="spaddress" style="color: white;background-color: red;"></span></div>
                                                </div>
                                            ...
                                            <div class="card-footer ">
                                                  <input type="submit" onclick="return validate();" name="sub" class="btn btn-primary btn-sm">
