...
if(isset($_POST['sub']))
{
    ...
    mysqli_query($conn,"INSERT INTO login_tb(username,password,type) VALUES ('$uname','$pss','4')");
    $id=mysqli_insert_id($conn);
    mysqli_query($conn,"INSERT INTO employee_tb(login_id,name,phone,email,address)VALUES ('$id','$nm','$ph','$eml','$add')");
    echo "<script>alert('New Security Added')</script>";
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Add security</li>
                        </ol>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="col-lg-8 ml-5">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>Security </strong> Resgistration
                                                    </div>
                                                        ...
                                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text"   class="form-control"maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"
                                                                  name="phone" id="phone_id" onkeyup="clearmsg('spphone')">  <span id="spphone" style="color: white;background-color: red;"></span></div>
                                                                
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="email-input" class=" form-control-label">Email </label></div>
                                                                <div class="col-12 col-md-9"><input type="email"   class="form-control" name="email" id="email_id" onkeyup="clearmsg('spemail')"><span id="spemail" style="color: white;background-color: red;"></span></div>
                                                            </div>
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" name="username" id="user_id" onkeyup="clearmsg('spuser')" class="form-control"><span id="spuser" style="color: white;background-color: red;"></span></div>
                                                                
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" name="password" onkeyup="clearmsg('sppass')" id="pass_id" class="form-control"><span id="sppass" style="color: white;background-color: red;"></span></div>
                                                            </div>
